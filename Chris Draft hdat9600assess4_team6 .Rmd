...
Brier_score <- mean(predicted_pro - icu_removed_na$in_hospital_death ^2)
Brier_score

icu_removed_na %>%mutate(predprob=predict(mod2, type="response")) -> icu_removed_na


roc(icu_removed_na$in_hospital_death, icu_removed_na$predprob, plot = TRUE, percent=TRUE)
